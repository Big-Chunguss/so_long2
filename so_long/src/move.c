...
/*   Updated: 2025/04/14 16:13:35 by agaroux          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move(t_data *data, char pos, int dir)
{
	...
	if (pos == 'y' && data->map->map[data->player.y
			+ dir][data->player.x] != '1' && (data->map->map[data->player.y
			+ dir][data->player.x] != 'E'
			|| data->collected == data->map->collect))
		data->player.y = data->player.y + dir;
	else if (pos == 'x' && data->map->map[data->player.y][data->player.x
		+ dir] != '1' && (data->map->map[data->player.y][data->player.x
			+ dir] != 'E' || data->collected == data->map->collect))
		data->player.x = data->player.x + dir;
	else if (pos == 'y' && data->map->map[data->player.y
			+ dir][data->player.x] == 'E' && data->collected
			!= data->map->collect)
